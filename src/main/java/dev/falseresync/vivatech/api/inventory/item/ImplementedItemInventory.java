 ...
 * Use {@link Inventories#readNbt(NbtCompound, DefaultedList)} and {@link Inventories#writeNbt(NbtCompound, DefaultedList)}
 ...
 */
@FunctionalInterface
public interface ImplementedItemInventory extends SidedInventory {
    /**
    ...
    ImplementedItemInventory EMPTY = ofSize(0);
     ...
     */
    static ImplementedItemInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static ImplementedItemInventory ofSize(int size) {
