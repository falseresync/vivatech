 ...
 * Use {@link Inventories#readNbt(NbtCompound, DefaultedList, RegistryWrapper.WrapperLookup)}
 * and {@link Inventories#writeNbt(NbtCompound, DefaultedList, RegistryWrapper.WrapperLookup)}
...
public interface ImplementedSidedInventory extends SidedInventory {
    ...
    ImplementedSidedInventory EMPTY = ofSize(0);
     ...
     */
    static ImplementedSidedInventory of(DefaultedList<ItemStack> items) {
        return () -> items;
    }
     ...
     * @return a new inventory
     */
    static ImplementedSidedInventory ofSize(int size) {
