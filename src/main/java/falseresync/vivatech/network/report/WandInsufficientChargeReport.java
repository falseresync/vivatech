...
public class WandInsufficientChargeReport implements Report {
    ...
    public void executeOnClient(ClientPlayerEntity player) {
        ...
        MinecraftClient.getInstance().inGameHud.setOverlayMessage(Text.translatable("hud.vivatech.wand.insufficient_charge").styled(style -> style.withColor(Formatting.DARK_RED)), false);
    }
}
